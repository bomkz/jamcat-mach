...
func InitMP3() []string {
	...
	for _, x := range paths {
		os.WriteFile(x+"RadioMusic\\0.mp3", blank, os.ModeAppend)
		os.WriteFile(x+"RadioMusic\\1.mp3", blank, os.ModeAppend)
		os.WriteFile(x+"RadioMusic\\2.mp3", blank, os.ModeAppend)
	}
